...
final insumoHistoryProvider = StreamProvider.family((ref, int insumoId) {
  ...
  return Rx.combineLatest2(
    insumoRepo.getAllInsumos().map((list) => list.where((i) => i.id == insumoId).firstOrNull),
        ...
        actions: [
          async.maybeWhen(
            data: (d) => Padding(
              ...
              child: TendenciaIndicador(tendencia: d.tendencia, showLabel: true),
            ),
